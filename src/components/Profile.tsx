...
const socials = [
  {
    name: "Github",
    link: "https://github.com/abuqaiselegant", // Add your GitHub profile URL
    icon: <FaGithub className="size-4" />,
  },
  {
    name: "LinkedIn",
    link: "https://linkedin.com/in/abuqais", // Add your LinkedIn profile URL
    icon: <FaLinkedin className="size-4" />,
  },

  // Removed Twitter if you don't use it
];
        ...
        <div className="flex flex-col items-start gap-2 ">
          <div className="flex flex-row md:flex-col items-center md:items-start w-full gap-4">
            <Image
              ...
              height={150}
              quality={100}
              src="/MyPic.jpeg" // Add your profile image to public folder
              alt="Profile Picture"
          ...
          <p className="mt-2 text-start text-sm text-muted-foreground">
            Problem solver who combines coding skills with analytical thinking
